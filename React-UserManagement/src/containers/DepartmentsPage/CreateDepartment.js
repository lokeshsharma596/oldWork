...
const CreateDepartment = () => {
  ...
  const [showNameStillCheckingError, setShowNameStillCheckingError] = useState(false)
  ...
  const createDepartment = async (arg) =>{
    const res= await Services.postApiCall(arg,'createDepartment')
    if(res.status == 201){
      dispatch(Actions.createDepartmentSuccess())
      dispatch(Actions.hideCreateDepartmentSideBar())
      dispatch(Actions.showDepartmentSuccessToast('Department added'))
      fetchDepartments()
    }else{
      dispatch(Actions.createDepartmentFailure(res.message))
    }
  }
  ...
  const handleSubmit = () => {
    ...
    if (data.name.trim().length === 0 || departmentData.departmentNameAvailable === false || departmentData.departmentNameAvailable === '' || departmentData.departmentNameCheckLoading === true) {
      ...
      if (departmentData.departmentNameAvailable === false || departmentData.departmentNameAvailable === '' || departmentData.departmentNameCheckLoading === true) {
        setShowNameStillCheckingError(true)
        setTimeout(() => {
          setShowNameStillCheckingError(false)
        }, 2000)
      }
    }
    else {
      createDepartment(data)
      // dispatch(Actions.createDepartmentRequest(data))
          ...
          <div className="article-right-col-1 w-650">
            ...
            <div className="articleRightPanel">
              <div className="rightPanelHeader categoryRightPanelHeader">
                <ul>
                  <li className="closing">
                    <span className="circlebtn" onClick={() => dispatch(Actions.hideCreateDepartmentSideBar())}>
                    ...
                    <div className="lm-basicInfo mt-3">
                      <div className="add-department right-panel-forems">
                        <div className="mt-3 mb-3 otherNameFeildsTitle">
                          <h4 className="card-title ticket-subtitle fnt-normal mb-1 fw-normal">Add Department</h4>
                        </div>
                          ...
                          <div className="col-sm-12">
                            <div className="wrapperInfo department">
                              <div className="md-form md-form-custom">
                                ...
                                />
                                <label htmlFor="inputMDEx2" className>Enter Description</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="row mb-3">
                          <div className="col-sm-12">
                            <div className="wrapperInfo department">
                              ...
                              <div className="md-form md-form-custom">
                              {departmentData.subStringsLoading && <span className="pree-loader"><img className="customgif" alt="" src="data:image/gif;base64," /></span>}            
                                ...
                                {(searchAgent.length > 0) ?
                                  <div className="mb-3 search_department">
                                    <ul className="input-tag__tags_search">

                                      {searchAgent.map((agent, i) =>
                                        <li className="visibleTo_serach" key={i}>
                                          <span className="selected">{toTitleCase(agent.name)}
              ...
              <div className="rightPanelFooter categoryRightPanelFooter">
                <button type="submit" className={(submitStatus ? 'rightPanelBtn btn disabled' : 'rightPanelBtn')} onClick={() => handleSubmit()}>
                  Add Department
                      </button>
              </div>
            </div>
