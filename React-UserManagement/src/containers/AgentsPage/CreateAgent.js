...
import { countries, timeZones, languages, compareJson, ValidateEmail, toTitleCase, CheckObjectPresentInArray } from "../../utils/functions"
...
const CreateAgent = () => {
  ...
  const [showEmailStillCheckingError, setShowEmailStillCheckingError] = useState(false)
  ...
  const fetchAgentSidebarData = async () => {
    ...
    console.log(res, "fetchAgentSidebarData")
    if (res.status == 201) {
      dispatch(Actions.fetchAgentSidebarDataSuccess(res.data))
      res.data.departments.map((department, i) => {
  ...
  const createAgent = async (arg) => {
    console.log(arg, "argument create agent")
    const res = await Services.postApiCall(arg, 'createAgent')
    console.log(res, "createAgent")
    if (res.status == 201) {
      dispatch(Actions.createAgentSuccess())
      dispatch(Actions.hideCreateAgentSideBar())
      dispatch(Actions.showAgentSuccessToast('Agent added'))
      dispatch(Actions.createAgentSuccess())
      fetchAgents()
    } else {
      dispatch(Actions.createAgentFailure(res.message))
    }
  }

  const checkAgentEmail = async (arg) => {
    dispatch(Actions.checkAgentEmailRequest())
    const res = await Services.getApiCall(arg, 'checkEmailExist')
    console.log(res, "res")
    if (res.data) {
      dispatch(Actions.checkAgentEmailSuccess({ "status": true, "message": "" }))
    } else {
      dispatch(Actions.checkAgentEmailSuccess({ "status": false, "message": "Email Already Exist" }))
    }
  }
  ...
  const handleSubmit = () => {
    ...
    const data = {
      ...
      password: password,
      status: status,
      role: (compareJson(permissions, agentData.role.permissions) ? role : `${role}*`),
    ...
    if (data.firstName.length === 0 || passwordValidator(password) === false || data.email.length === 0 || ValidateEmail(data.email) || data.password.length === 0 || role.length === 0 || role === 'Agent Role *' || agentData.agentEmailAvailable === false || agentData.agentEmailAvailable === '' || agentData.agentEmailCheckLoading === true || agentData.roleLoading) {
      ...
      if (data.email.length === 0) {
        setShowEmailRequiredError(true)
        setTimeout(() => {
      ...
      if (agentData.agentEmailCheckLoading === true) {
        setShowEmailStillCheckingError(true)
        setTimeout(() => {
          setShowEmailStillCheckingError(false)
        }, 2000)
      }
    } else {
      ...
      if (agentData.roleLoading) {
        ...
        createAgent(data)
        // dispatch(Actions.createAgentRequest(data))
              ...
              <div className="rightPanelHeader categoryRightPanelHeader">
                <ul>
                  <li className="closing">
                    <span className="circlebtn" onClick={() => dispatch(Actions.hideCreateAgentSideBar())}>
                  ...
                  <li className="help position-relative cursorPointer ">
                    <span className="profile-settings-drp ">
                      {(showSetting) ?
                        <span className="preferences-hover-text" onClick={() => setShowSetting(false)}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="18.135" height="18.135" viewBox="0 0 18.135 18.135">
                            <path id="Icon_material-mode-edit" data-name="Icon material-mode-edit" d="M4.5,18.854v3.778H8.278L19.419,11.49,15.642,7.712ZM22.341,8.569a1,1,0,0,0,0-1.42L19.984,4.791a1,1,0,0,0-1.42,0L16.72,6.634,20.5,10.412Z" transform="translate(-4.5 -4.496)" />
                          </svg>  Edit Permission</span>
                        ...
                        <div className="profile-Profile profile-settings-rightpanel right-panel-forems">
                          <div className="lm-user-pic mb-3 mt-0">
                            <div className="editImage position-relative">
                              <img src={(imageAsUrl) ? imageAsUrl : (previewImage) ? previewImage : "/images/dummy-avatar.jpg"} className="rounded img-fluid " alt="" />
                                    ...
                                    <div className="card-head">
                                      <div className="enter-link">
                                        <div className="md-form md-form-custom mt-2 mb-2">
                                          ...
                                          />
                                          <label for="inputMDExlink71" className={(facebookLink ? 'active' : '')}>Enter Links:
                                        </label>
                                    ...
                                    <div className="card-head">
                                      <div className="enter-link">
                                        ...
                                        <div className="md-form md-form-custom mt-2 mb-2">
                                          ...
                                          />
                                          <label for="inputMDExlink72" className={(twitterLink ? 'active' : '')}>Enter Links:
                                        </label>
                                          <span className="searchIcon-dep" onClick={() => setEventType("close")}>
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  />
                                  <label for="inputMDEx1" className>First Name*</label>
                            ...
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  />
                                  <label for="inputMDEx2" className>Last Name</label>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  />
                                  <label for="inputMDEx3" className>Alias</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="row mb-3">
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                {agentData.agentEmailCheckLoading && <span className="pree-loader"><img className="customgif" alt="" src="data:image/gif;base64," /></span>}
                                    ...
                                    onBlur={(e) => {
                                      if (e.target.value.trim().length > 0) {
                                        if (ValidateEmail(e.target.value)) {
                                          ...
                                          dispatch(Actions.resetAgentEmail())
                                        } else {
                                          checkAgentEmail({ email: e.target.value.trim().toLowerCase(), userId: localStorage.getItem('userId') })
                                          // dispatch(Actions.checkAgentEmailRequest({ email: e.target.value.trim().toLowerCase(), userId: localStorage.getItem('userId') }))
                                        }
                                      }

                                    }}
                                  />
                                  <label for="inputMDEx5" className>Email*</label>
                                  {(agentData.agentEmailAvailable === false) ?
                                    <div className="invalid-feedback">{agentData.agentEmailCheckMessage}</div>
                                    : null
                                  }
                                  {(showEmailStillCheckingError) ?
                                    <p className="invalid-feedback">Please Wait,Checking Email!</p>
                                    : null
                                  }
                                  {showEmailRequiredError ? <div className="invalid-feedback">Required</div> : null}
                                  {showInvalidEmailError ? <div className="invalid-feedback">Invalid Email</div> : null}
                            ...
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  <label for="inputMDEx5" className>Password*</label>
                            ...
                            <div className="col-sm-6">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  />
                                  <label for="inputMDEx10" className>Designation</label>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="col-sm-12">
                              <div className="wrapperInfo">
                                <div className="md-form md-form-custom agent-form">
                                  ...
                                  />
                                  <label for="inputMDEx11" className>Address</label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="rightPanelFooter categoryRightPanelFooter">
                            <button className={(submitStatus ? 'rightPanelBtn btn disabled' : 'rightPanelBtn')} type="submit" onClick={() => handleSubmit()}>Add Agent</button></div>
                        </div>
