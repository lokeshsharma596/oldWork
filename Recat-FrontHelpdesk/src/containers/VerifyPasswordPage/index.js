...
import { resendOtpRequest, verifyOtpRequest,setSignupSuccessPage } from "../BaseLayout/actions"
...
const Index = (props) => {
    ...
    if(baseData.loadSignupSuccessPage){
        history.push(`/signup-success`)
        dispatch(setSignupSuccessPage(false));
    }
        ...
        <BaseLayout>
            <Formik
                ...
                onSubmit={async fields => {
                    dispatch(verifyOtpRequest({ email: atob(props.match.params.id),otp: fields.verify, org_id: baseData.settings.usersettings.userId,portalName:baseData.settings.usersettings.portalname,url:`https://${window.location.hostname.split('.')[0]}.appypiedesk.com` }))
                }}
            >
                                    ...
                                    <div className="container ps-relative">
                                        <div className="signupFeilds">
                                            ...
                                            <div className="headings-login-signup">
                                                ...
                                                <p>Please enter the verification code that we sent you on your provided mail to continue signing up.</p>
                                            </div>
                                            <div className="feilds-new">
                                                ...
                                                <div className="user-feilds">
                                                    <div className="login-signup-btn k-flex align-items-center">
                                                        ...
                                                        <a onClick={()=>{
                                                            dispatch(resendOtpRequest({ email: atob(props.match.params.id), org_id: baseData.settings.usersettings.userId,portalName:baseData.settings.usersettings.portalname,url:`https://${window.location.hostname.split('.')[0]}.appypiedesk.com` }))
                                                        }} 
                                                        href="Javascript:void(0)" style={{ color: 'rgb(104, 155, 239)', float: 'right' }} className="ml-2">Resend</a>
                                                    </div>
