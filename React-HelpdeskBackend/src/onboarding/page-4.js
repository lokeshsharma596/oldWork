...
class CongratulationOnbording extends React.Component{
    render(){
        return(
<div classname="main-wrapper" id="main-wrapper">
  <div>
    <header className="topbar no--click">
      <nav className="navbar top-navbar k-flex justify-content-end align-items-center non-click">
        ...
        <ul className="navbar-nav navbar-nav-right">
          <li className="mobile-show" style={{paddingTop: 12}}>
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 17.49 17.49">
                <path id="ic_zoom_out_24px" d="M15.5,14h-.79l-.28-.27a6.51,6.51,0,1,0-.7.7l.27.28v.79l5,4.99L20.49,19Zm-6,0A4.5,4.5,0,1,1,14,9.5,4.494,4.494,0,0,1,9.5,14Z" transform="translate(-3 -3)" fill="#a2abd1" />
              </svg>
            </span>
          </li>
              ...
              <ul>
                <li>
                  <a className="dropdown-item" href="#">
                    <span className="icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14.734" height="18.418" viewBox="0 0 14.734 18.418">
                        <path id="ic_description_24px" d="M13.209,2H5.842A1.839,1.839,0,0,0,4.009,3.842L4,18.576a1.839,1.839,0,0,0,1.833,1.842h11.06a1.847,1.847,0,0,0,1.842-1.842V7.525Zm1.842,14.734H7.684V14.893h7.367Zm0-3.684H7.684V11.209h7.367Zm-2.763-4.6V3.381l5.065,5.065Z" transform="translate(-4 -2)" fill="#bebebe" />
                      </svg>
                    </span>
                    <span className="preview-item-content">Article</span>
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="#">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="19.1" height="19.1" viewBox="0 0 19.1 19.1">
                        <g id="ticket" transform="translate(0 -0.001)">
                          <g id="Group_1764" data-name="Group 1764" transform="translate(0 0.001)">
                            <path id="Path_1670" data-name="Path 1670" d="M18.681,6.338,17.253,4.921a2.189,2.189,0,0,1-3.083,0,2.1,2.1,0,0,1-.635-1.542,2.1,2.1,0,0,1,.635-1.542L12.753.42A1.464,1.464,0,0,0,10.7.42L.42,10.69a1.464,1.464,0,0,0,0,2.052L1.836,14.17a2.1,2.1,0,0,1,1.542-.635,2.1,2.1,0,0,1,1.542.635,2.189,2.189,0,0,1,0,3.083l1.428,1.428a1.464,1.464,0,0,0,2.052,0L18.681,8.389a1.464,1.464,0,0,0,0-2.052ZM15.609,8.6,8.6,15.61a.739.739,0,0,1-1.02,0l-4.1-4.1a.712.712,0,0,1,0-1.02l7.005-7.005a.74.74,0,0,1,1.02,0l4.1,4.1a.711.711,0,0,1,0,1.02Z" transform="translate(0 -0.001)" fill="#bebebe" />
                            <path id="Path_1671" data-name="Path 1671" d="M120.136,113.639l3.582,3.582-6.484,6.484-3.582-3.582Z" transform="translate(-109.14 -109.127)" fill="#bebebe" />
                          </g>
                        </g>
                      </svg>
                    </span>
                    <span className="preview-item-content">Ticket</span>
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="#">
                    <span className="icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16.02" height="19.223" viewBox="0 0 16.02 19.223">
                        <path id="ic_contacts_24px" d="M16.418,0H3.6V1.6H16.418ZM3.6,19.223H16.418v-1.6H3.6ZM16.418,3.2H3.6A1.607,1.607,0,0,0,2,4.806v9.612a1.607,1.607,0,0,0,1.6,1.6H16.418a1.607,1.607,0,0,0,1.6-1.6V4.806A1.607,1.607,0,0,0,16.418,3.2Zm-6.408,2.2a1.8,1.8,0,1,1-1.8,1.8A1.8,1.8,0,0,1,10.01,5.407Zm4,8.21H6v-1.2c0-1.338,2.667-2,4-2s4,.665,4,2Z" transform="translate(-2)" fill="#bebebe" />
                      </svg>
                    </span>
                    <span className="preview-item-content">Contact</span>
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="#">
                    <span className="icon">
                      <svg id="Group_1765" data-name="Group 1765" xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20">
                        <g id="Group_1766" data-name="Group 1766" transform="translate(0 6.797)">
                          <g id="Group_1765-2" data-name="Group 1765">
                            <path id="Path_1672" data-name="Path 1672" d="M13.516,179.664a.391.391,0,0,0-.391.391v2.7a1.955,1.955,0,0,1-1.953,1.953H6.954a.391.391,0,0,0-.391.39v.777l-.932-.932a.391.391,0,0,0-.358-.235H2.734A1.955,1.955,0,0,1,.781,182.75v-6.016a1.955,1.955,0,0,1,1.953-1.953H6.68a.391.391,0,1,0,0-.781H2.734A2.737,2.737,0,0,0,0,176.734v6.016a2.737,2.737,0,0,0,2.734,2.734H5.073l1.6,1.6a.391.391,0,0,0,.667-.276v-1.328h3.827a2.737,2.737,0,0,0,2.734-2.734v-2.7A.391.391,0,0,0,13.516,179.664Z" transform="translate(0 -174)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1768" data-name="Group 1768" transform="translate(7.656)">
                          <g id="Group_1767" data-name="Group 1767">
                            <path id="Path_1673" data-name="Path 1673" d="M202.666,0h-.989a5.678,5.678,0,0,0,0,11.355h.989a5.688,5.688,0,0,0,1.441-.185l1.46,1.46a.391.391,0,0,0,.667-.276v-2.26a5.732,5.732,0,0,0,1.492-1.84,5.616,5.616,0,0,0,.617-2.576A5.684,5.684,0,0,0,202.666,0Zm2.943,9.591a.391.391,0,0,0-.156.312v1.508l-.956-.955a.39.39,0,0,0-.391-.1,4.9,4.9,0,0,1-1.44.215h-.989a4.9,4.9,0,0,1,0-9.793h.989a4.9,4.9,0,0,1,2.943,8.81Z" transform="translate(-196)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1770" data-name="Group 1770" transform="translate(12.284 2.737)">
                          <g id="Group_1769" data-name="Group 1769">
                            <path id="Path_1674" data-name="Path 1674" d="M317.766,71.6a1.658,1.658,0,0,0-1.533-1.533,1.641,1.641,0,0,0-1.245.441,1.66,1.66,0,0,0-.526,1.209.391.391,0,0,0,.781,0,.873.873,0,0,1,.935-.87.873.873,0,0,1,.129,1.722.739.739,0,0,0-.582.725v.938a.391.391,0,0,0,.781,0v-.907A1.645,1.645,0,0,0,317.766,71.6Z" transform="translate(-314.462 -70.063)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1772" data-name="Group 1772" transform="translate(13.547 8.06)">
                          <g id="Group_1771" data-name="Group 1771">
                            <path id="Path_1675" data-name="Path 1675" d="M347.467,206.444a.391.391,0,1,0,.114.276A.394.394,0,0,0,347.467,206.444Z" transform="translate(-346.8 -206.33)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1774" data-name="Group 1774" transform="translate(2.109 12.109)">
                          <g id="Group_1773" data-name="Group 1773">
                            <path id="Path_1676" data-name="Path 1676" d="M62.633,310H54.391a.391.391,0,1,0,0,.781h8.242a.391.391,0,0,0,0-.781Z" transform="translate(-54 -310)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1776" data-name="Group 1776" transform="translate(10.352 14.297)">
                          <g id="Group_1775" data-name="Group 1775">
                            <path id="Path_1677" data-name="Path 1677" d="M265.667,366.114a.39.39,0,1,0,.114.276A.393.393,0,0,0,265.667,366.114Z" transform="translate(-265 -366)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1778" data-name="Group 1778" transform="translate(2.109 14.297)">
                          <g id="Group_1777" data-name="Group 1777">
                            <path id="Path_1678" data-name="Path 1678" d="M61.1,366H54.391a.391.391,0,1,0,0,.781H61.1a.391.391,0,0,0,0-.781Z" transform="translate(-54 -366)" fill="#bebebe" />
                          </g>
                        </g>
                        <g id="Group_1780" data-name="Group 1780" transform="translate(2.109 9.922)">
                          <g id="Group_1779" data-name="Group 1779">
                            <path id="Path_1679" data-name="Path 1679" d="M60.094,254h-5.7a.391.391,0,0,0,0,.781h5.7a.391.391,0,0,0,0-.781Z" transform="translate(-54 -254)" fill="#bebebe" />
                          </g>
                        </g>
                      </svg>
                    </span>
                    <span className="preview-item-content">Community Post</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <li>
            <a className="notification-wrapper">
              <span>
          ...
          <li className="nav-item dropdown">
            <a data-toggle="dropdown"><span className="profileHeader"> <img src={('../../public/images/profile.jpg')} alt="profile" /></span></a>
              ...
              <div className="user-profile-dropdown">
                <div>
                  <p className="signOut">
                    <span>
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="13.752" height="13.974" viewBox="0 0 13.752 13.974">
                  ...
                  <div className="profile-image-header"><img src={('../../public/images/profile.jpg')} /></div>
                  <div className="name-profile-header pt-3 pb-3 text-center">
                    <h4 className="card-title">Test3238</h4>
                    <p className="card-body-text"> </p>
                  </div>
                  <div className="name-email-header border-bottom text-center pb-3">
                    <p className="card-body-text"><a href="Test3238@yopmail.com">Test3238@yopmail.com</a></p>
                    <p className="card-body-text"><a href="telto:+919876543210" /></p>
                  </div>
                  <div className="header-drp-policy pt-2 pb-2 text-center">
                    <ul>
                      <li><a href="/knowledge/privacysettings">Privacy Settings</a></li>
    ...
    <div>
      <aside className="left-sidebar non-click no--click">
        <div className="lef-nav-logo"><span className="topHederLogo"><img src={('../../public/images/logo-icon.svg')} /></span></div>
        <div className="scroll-sidebar side-navbarMenu">
          <nav className="sidebar-nav sidebarTop-nav">
            <ul className="sidebarnav">
              <li className="selected"><a href="/knowledge/categorylisting"><span><i className="icon customicon-solution selected" /></span></a></li>
              <li><a href="/knowledge/desksettings"><span><i className="icon customicon-settings " /></span></a></li>
            </ul>
          </nav>
          <nav className="sidebar-nav sidebarBottom-nav">
            <ul className="sidebarnav">
              <li title="Help "><a href="https://www.appypiedesk.com/Appy-Pie-Knowledge" target="_blank"><span><img src={('../../public/images/ionic-ios-help-circle.svg')} /></span></a></li>
              <li className="selected ps-relative" title=" Feedback"><a><span><img src={('../../public/images/Group_4332.svg')} /></span></a></li>
            </ul>
          </nav>
        </div>
      </aside>
    ...
    <div>
      <div className="page-wrapper">
        <div className="container-fluid main-container congratulation_bg">
          <div className="centerMainContainer">
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div className="onboarding-congratulation help-center bg-animatio--" id="cardBody">
                  <div className="step-create-change pt-2 pl-3" />
                  <div className="card-body-create-knowledge-inner border-three">
                    <div className="knowledge-card-alltitle text-center py-4 px-4">
                        <img src={('../../public/images/trophy-onboarding.svg')} style={{width: '70px'}} />
                      <h6 className="card-body-title">Congratulations!  </h6>
                      {/* <p className="card-body-text">Your customers can now get all the information they need with great ease.</p> */}
                    </div>
                    <div className="congratulation-onboarding-formfeilds">
                        <div className="congra-filds px-5">
                            <div className="feilds-cong-row mb-4">
                                <h5 className="pb-1">Your desk is now setup at…</h5>
                                <div className="wrapperInfo ps-relative">
                                    <input type="text" placeholder="Astha1.appypiedesk.com" className="w-100" defaultValue="Astha1.appypiedesk.com" />
                                    <div className="congratulation-feilds-icon">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.398" height="24.398" viewBox="0 0 24.398 24.398">
                                                <g id="Icon_feather-copy" data-name="Icon feather-copy" transform="translate(1.25 1.25)">
                                                    <path id="Path_2867" data-name="Path 2867" d="M15.69,13.5h9.854a2.19,2.19,0,0,1,2.19,2.19v9.854a2.19,2.19,0,0,1-2.19,2.19H15.69a2.19,2.19,0,0,1-2.19-2.19V15.69A2.19,2.19,0,0,1,15.69,13.5Z" transform="translate(-5.836 -5.836)" fill="none" stroke="#dedede" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"/>
                                                    <path id="Path_2868" data-name="Path 2868" d="M6.285,17.234H5.19A2.19,2.19,0,0,1,3,15.044V5.19A2.19,2.19,0,0,1,5.19,3h9.854a2.19,2.19,0,0,1,2.19,2.19V6.285" transform="translate(-3 -3)" fill="none" stroke="#dedede" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"/>
                                                </g>
                                            </svg>
                                        </span>
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8.833" height="23.555" viewBox="0 0 8.833 23.555">
                                                <path id="Icon_awesome-info" data-name="Icon awesome-info" d="M.92,19.517h.92V12.871H.92a.92.92,0,0,1-.92-.92v-2.2a.92.92,0,0,1,.92-.92H6.073a.92.92,0,0,1,.92.92v9.764h.92a.92.92,0,0,1,.92.92v2.2a.92.92,0,0,1-.92.92H.92a.92.92,0,0,1-.92-.92v-2.2A.92.92,0,0,1,.92,19.517ZM4.417,0A3.312,3.312,0,1,0,7.729,3.312,3.312,3.312,0,0,0,4.417,0Z" fill="#dedede"/>
                                            </svg>
                                        </span>
                                    </div>
                                </div>
                                <p className="notes pt-1">Note: Don't worry, you can change this later in the <a href="">Settings</a> section</p>
                            </div>
                            <div className="feilds-cong-row">
                                 <h6 className="pb-1">Also, copy your Appy Pie Desk support email</h6>
                                <div className="wrapperInfo ps-relative">
                                    <input type="text" placeholder="support@astha1.appypiedesk.com" className="w-100" defaultValue="support@astha1.appypiedesk.com" />
                                    <div className="congratulation-feilds-icon">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.398" height="24.398" viewBox="0 0 24.398 24.398">
                                                <g id="Icon_feather-copy" data-name="Icon feather-copy" transform="translate(1.25 1.25)">
                    ...
                    <div className="knowledge-create-row px-4">
                      <div className="create-categroy-feilds create-knowledgeFeilds mt-4 pb-4">
                        <p className="text-center pb-3">All incoming emails to the above address will automatically be converted to Tickets. Apply forwarding rules to your support email address</p>
                        <div className="createArticle-or-importcsv k-flex align-items-center justify-content-center"><button className="btnBlue dropdown py-3 px-5">Go to Inbox</button></div>
                        <p className="text-center py-3 color-lightgray">Sync Support Email</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="onboarding-congratulation help-center bg-animatio--" id="cardBody" style={{display: 'none'}}>
                  <div className="step-create-change pt-2 pl-3" />
                  <div className="card-body-create-knowledge-inner border-three">
                    <div className="knowledge-card-alltitle text-center py-4 px-4">
                        <img src={('../../public/images/trophy-onboarding.svg')} style={{width: '70px'}} />
                    ...
                    <div className="congratulation-onboarding-formfeilds">
                        <div className="congra-filds px-5">
                            <div className="feilds-cong-row mb-4">
                                <h5 className="pb-1">Your Knowledge Base is now setup at</h5>
                                <div className="wrapperInfo ps-relative">
                                    <input type="text" placeholder="Astha1.appypiedesk.com" className="w-100" defaultValue="Astha1.appypiedesk.com" />
                                    <div className="congratulation-feilds-icon">
                                        <span>
                    ...
                    <div className="knowledge-create-row px-4">
                      <div className="create-categroy-feilds create-knowledgeFeilds mt-4 pb-4">
                        <p className="text-center pb-3">Start adding articles & enable self service for all your customer queries.</p>
                        <div className="createArticle-or-importcsv k-flex align-items-center justify-content-center"><button className="btnBlue dropdown py-3 px-5">Add Article</button></div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div className="botomFooter">
      <div className="row">
        <div className="col-xs-12 col-sm-12 col-md-3 col-lg-2 vcenter mobilr-center"><a href="#" className="footer-logo" role="link"><img src="https://images.appypie.com/wp-content/uploads/2020/03/16070955/appypie-logo.svg" data-no-lazy={1} width={147} height={42} /></a></div>
          ...
          <div className="socialLinks">
            <ul className="social_icons-footer">
              <li className="facebook">
                <a href="https://www.facebook.com/AppyPieInc" rel="nofollow noopener" title="Facebook" role="link">
                  Facebook
              ...
              <li className="twitter">
                <a href="https://twitter.com/AppyPieInc" rel="nofollow noopener" title="Twitter" role="link">
                  Twitter
              ...
              <li className="pin">
                <a href="https://www.pinterest.com/appypie/" rel="nofollow noopener" title="Pinterest" role="link">
                  Pinterest
              ...
              <li className="blog">
                <a href="https://www.appypie.com/blog" rel="nofollow noopener" title="Appypie blog" role="link">
                  Appypie blog
              ...
              <li className="linden">
                <a href="https://www.linkedin.com/company/appy-pie-inc/" rel="nofollow noopener" title="linkedin" role="link">
                  linkedin
              ...
              <li className="youtube">
                <a href="https://www.youtube.com/user/AppyPieInc" rel="nofollow noopener" title="Youtube" role="link">
                  Youtube
              ...
              <li className="instagram">
                <a href="https://www.instagram.com/AppyPieInc/" rel="nofollow noopener" title="Instagram" role="link">
                  Instagram
              ...
              <li className="news"><a href="https://news.appypie.com/" rel="nofollow noopener" title="Appy Pie News" role="link">Appy Pie News<span className="newsicon"><img alt="Appy Pie News" src="https://www.appypie.com/wp-content/uploads/2019/10/newsicon.svg" width={25} height={25} data-lazy-src="https://www.appypie.com/wp-content/uploads/2019/10/newsicon.svg" className="lazyloaded" data-was-processed="true" style={{width: '100%'}} /></span></a></li>
            </ul>
          </div>
        </div>
...
export default CongratulationOnbording;