...
class Emaildefault extends React.Component{
    render(){
        return(
      ...
      <nav className="navbar top-navbar k-flex justify-content-end align-items-center non-click">
        ...
        <ul className="navbar-nav navbar-nav-right">
          ...
          <li className="nav-item dropdown" style={{display: 'none'}}>
            <a href="#" data-toggle="dropdown" className=" waves-effect waves-light">
              <span>
          ...
          <li>
            <a className="notification-wrapper waves-effect waves-light">
              <span>
          ...
          <li className="nav-item dropdown">
            <a data-toggle="dropdown" className=" waves-effect waves-light"><span className="profileHeader"><img src={('../../public/images/profile.jpg')} alt="profile" /></span></a>
              ...
              <div className="user-profile-dropdown">
                <div>
                  ...
                  <div className="name-email-header border-bottom text-center pb-3">
                    <p className="card-body-text"><a href="Test3238@yopmail.com" className=" waves-effect waves-light">Test3238@yopmail.com</a></p>
                    <p className="card-body-text"><a href="telto:+919876543210" className=" waves-effect waves-light" /></p>
                  </div>
                  <div className="header-drp-policy pt-2 pb-2 text-center">
                    <ul>
                      <li><a href="/knowledge/privacysettings" className=" waves-effect waves-light">Privacy Settings</a></li>
                      <li><a href="https://www.appypie.com/terms-of-use" target="_blank" className=" waves-effect waves-light">Terms &amp; Conditions</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div className="container-fluid main-container">
          <div className="centerMainContainer">
            <div>
              ...
              <div className="row">
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div className="page-heading body-heading k-flex"><span className="icon customicon-solution-home mr-2 fnt-24 menu-toggle" /><span className="body-heading-span">Email</span></div>
                </div>
              </div>
            </div>
            <div className="row">
                  ...
                  <div className="category-tiles">
                    <div className="category-header k-flex">
                      ...
                      <div className="categoryHeaderRight">
                        <ul>
                         <li><button className="btn-all btnBlue">New Email +</button></li>
                        </ul>
                      </div>
                    </div>
                    <div className="category-row">
                        <div className="categroy-emails">
                            <div className=" defaultEmail k-flex align-items-center makefolder-bg px-4 py-3">
                                <div className="defaultUser">
                                    <h5 className="card-title mb-0">Default</h5>
                                    <p className="card-body-text color-lightgray">support@asthaorg.appypie.com</p>
                                </div>
                                <div className="defaultUser k-flex align-items-center ml-auto">
                                    <div className="onboarding_listing mr-4">
                                         <a href="#" className="color-blueTheme">Edit</a> /  <a href="#" className="color-blueTheme">Delete</a>
                                    </div>
                                    <div className="switch_onboarding_status">
                                        <div className="material-switch">
                                            <input id="someSwitchOptionPrimary1" name="knoledgebase1" type="checkbox" />
                            ...
                            <div className=" defaultEmail k-flex align-items-center makefolder-bg px-4 py-3">
                                ...
                                <div className="defaultUser k-flex align-items-center ml-auto">
                                    ...
                                    <div className="switch_onboarding_status">
                                        <div className="material-switch">
                                            <input id="someSwitchOptionPrimary2" name="knoledgebase2" type="checkbox" />
                            ...
                            <div className=" defaultEmail k-flex align-items-center makefolder-bg px-4 py-3">
                                ...
                                <div className="defaultUser k-flex align-items-center ml-auto">
                                    ...
                                    <div className="switch_onboarding_status">
                                        <div className="material-switch">
                                            <input id="someSwitchOptionPrimary3" name="knoledgebase3" type="checkbox" />
                            ...
                            <div className=" defaultEmail k-flex align-items-center makefolder-bg px-4 py-3">
                                ...
                                <div className="defaultUser k-flex align-items-center ml-auto">
                                    ...
                                    <div className="switch_onboarding_status">
                                        <div className="material-switch">
                                            <input id="someSwitchOptionPrimary4" name="knoledgebase4" type="checkbox" />
                                            <label htmlFor="someSwitchOptionPrimary4" className="label-primary" />
                                        </div>
                                    </div>
                                </div>
                            </div>
