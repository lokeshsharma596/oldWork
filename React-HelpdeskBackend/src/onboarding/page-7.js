...
class MyinboxTicket extends React.Component{
    render(){
        return(
  ...
  <div>
    ...
    <div>
      <div className="page-wrapper">
          <div className="support-emails py-3">
          Sync your support email address <button className="btnWhite">Click Here</button>
          </div>
        <div className="container-fluid main-container">
          <div className="centerMainContainer">
            <div>
                  ...
                  <div className="customeBreadcrumb pb-2">
                    <nav aria-label="breadcrumb">
                      <ol className="breadcrumb">
                        <li className="breadcrumb-item"><a href="#">My Inbox</a></li>
                      </ol>
                    </nav>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div className="page-heading body-heading k-flex"><span className="icon customicon-solution-home mr-2 fnt-24 menu-toggle" /><span className="body-heading-span">My Inbox</span></div>
                </div>
              </div>
              <div className="row">
                   <div className="col-xs-12 col-md-12">
                    <div className="no-rescent-ticket bg-white py-5 px-5">
                            <div className="no-ticket-img text-center">
                                <img src={('../../public/images/no-ticket.svg')} />
                            </div>
                            <div className="ticket-details-para text-center">
                                <h4 className="card-title">No Recent Ticket Has Been Added </h4>
                                <p className="card-body-text color-lightgray">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae</p>
                                <button className="btnBlue mt-5">Add Ticket</button>
                            </div>
