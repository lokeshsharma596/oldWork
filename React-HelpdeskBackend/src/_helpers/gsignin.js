...
class Gsignin extends React.Component {
    ...
    constructor(props) {
        ...
        if(query.get('code')){
            ...
            let url = 'https://gauth.appypiedesk.com/oauth2/token?grant_type=authorization_code&code='+query.get('code')+'&redirect_uri='+host+'/gsignin&client_id=6nkq3rphk4gae0dchcnfvtpmdj&scope=openid+email';
            console.log(url);
            ...
            .then(
                result => { 
                           ...
                           window.opener.location.href=host+'/login';
